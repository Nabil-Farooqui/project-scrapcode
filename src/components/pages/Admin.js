...
<div class="card text-white bg-primary m ml-3 my-3 shadow p-3 mb-5 rounded" style={{width: "100%",height:"100%"}}>
  ...
  <div  class="mt-5" style={{textAlign:"center"}} > <a href="#" class="text-white" style={{textDecoration:"none"}}><h5>Total Customer</h5></a></div>
...
<div class="card text-white bg-success  ml-3 my-3  shadow p-3 mb-5 rounded" style={{width: "100%",height:"100%"}}>
  ...
  <div  class="mt-5" style={{textAlign:"center"}}> <a href="#" class="text-white" style={{textDecoration:"none"}}><h5>Total Mechanic</h5></a></div>
...
<div class="card text-white bg-warning  ml-3 my-3  shadow p-3 mb-5 rounded " style={{width: "100%",height:"100%"}}>
  ...
  <div  class="mt-5" style={{textAlign:"center"}}> <a href="#" class="text-white" style={{textDecoration:"none"}}><h5>Total Enquiry</h5> </a></div>
...
<div class="card text-white bg-danger  ml-3 my-3  shadow p-3 mb-5 rounded" style={{width: "100%",height:"100%"}}>
  ...
  <div  class="mt-5" style={{textAlign:"center"}}> <a href="Profile" class="text-white" style={{textDecoration:"none"}}><h5>Total Feedback</h5></a></div>
  <div class="mt-3" style={{textAlign:"center"}}>
